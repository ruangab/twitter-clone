        ...
        <>
            <div className="w-2/5 text-white h-12 pl-32 py-4 h-auto">
                ...
                <nav className="mt-5 px-2">
                    <a
                        onClick={clickHome}
                        className="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-stone-950 hover:text-blue-300"
                    >
                        <svg
                    ...
                    <a
                        onClick={clickTrenging}
                        className="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-stone-950 hover:text-blue-300"
                    >
                        <svg
                            className="mr-4 h-6 w-6"
                            fill="none"
                    ...
                    <a
                        href="#"
                        className="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-stone-950 hover:text-blue-300"
                    >
                        <svg
                            className="mr-4 h-6 w-6"
                            fill="none"
